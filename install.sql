...
CREATE TABLE transactions (
  id int NOT NULL comment 'Internal transaction id',
  uuid varchar(40) NOT NULL comment 'Universal transaction id',
  version tinyint NOT NULL DEFAULT 1 comment 'Transaction version number',
...
CREATE TABLE entries (
  ...
  txid int NOT NULL comment 'corresponds to transactions table id',
...
CREATE TABLE `transaction_index` (
  ...
  income BIGINT  NOT NULL COMMENT 'for aggregated queries: positive or zero for uid1',
  expenditure BIGINT NOT NULL COMMENT 'for aggregated queries: positive or zero for uid1',
  diff BIGINT NOT NULL COMMENT 'for aggregated queries: positive for payee, negative for payer',
  volume BIGINT NOT NULL COMMENT 'for aggregated queries: always positive',
